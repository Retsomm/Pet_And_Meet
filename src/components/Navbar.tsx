    ...
    <div className="navbar bg-base-100 shadow-lg fixed top-0 l-0 z-50 max-sm:hidden p-0">
      ...
      <div className="flex-none mx-10">
        <ul className="menu menu-horizontal px-1 items-center">
          ...
          <li>
            {isLoggedIn ? (
              <Link to="/profile" className="navLink" aria-label="個人資料">
                <img src={user?.avatarUrl || "https://i.pravatar.cc/40"} alt="User Avatar" className="w-12 h-auto cursor-pointer" />
              </Link>
            ) : (
          ...
          <li>
            <div className="navLink flex items-center tooltip tooltip-bottom" data-tip="switchTheme">
